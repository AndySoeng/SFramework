...
{
    internal class CS_LitShaderExperimental : BaseShaderGUI
    {
        ...
        private const int queueOffsetRange = 500;
        ...
        {
            //The below supresses _ZWrite and RenderQueue settings
        ...
        public override void DrawSurfaceInputs(Material material)
        {
            ...
            if (__zw != null) materialEditor.ShaderProperty(__zw, "_ZWrite");
