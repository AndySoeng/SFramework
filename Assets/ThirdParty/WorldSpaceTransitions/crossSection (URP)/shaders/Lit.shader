Shader "CrossSectionURP/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma multi_compile __ CLIP_PLANE CLIP_SPHERE CLIP_BOX CLIP_CORNER CLIP_NONE CLIP_SPHERE_OUT CLIP_PIE
			//#pragma shader_feature CLIP_NONE CLIP_SPHERE_OUT CLIP_PIE
