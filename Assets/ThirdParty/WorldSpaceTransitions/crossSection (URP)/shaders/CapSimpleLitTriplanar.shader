...
Shader "CrossSectionURP/CapSimpleLit/HatchTriplanar"
{
    ...
    Properties
    {
		...
		[Toggle(_BOXMAP)] _boxmap("local space box mapping", Float) = 0
    }
	...
	SubShader
	{
		...
		Pass
		{
            ...
            #pragma fragment LitPassFragmentSimpleTriplanar
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.SimpleLitCapShader"
}
