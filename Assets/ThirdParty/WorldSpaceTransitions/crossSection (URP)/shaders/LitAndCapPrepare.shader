Shader "CrossSectionURP/LitAndCapPrepare"
{
    Properties
    {
    ...
    SubShader
    {
		...
		#pragma multi_compile __ CLIP_PLANE CLIP_SPHERE CLIP_BOX CLIP_CORNER CLIP_SPHERE_OUT CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS

		//#pragma shader_feature CLIP_NONE CLIP_SPHERE_OUT CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS
		...
		Pass
		{
			...
			//--------------------------------------
			// CrossSection Keywords
			#pragma multi_compile __ CLIP_PLANE CLIP_SPHERE CLIP_BOX CLIP_CORNER CLIP_NONE CLIP_SPHERE_OUT CLIP_PRISM CLIP_PRISMS CLIP_CYLINDERS CLIP_CYLINDER CLIP_TETRA CLIP_TETRAS CLIP_CONE CLIP_CONES CLIP_ELLIPSOID CLIP_ELLIPSOIDS CLIP_CUBOID CLIP_CUBOIDS
	...
	//CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.CS_LitShaderExperimental"
	CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.CS_LitShader"
}
