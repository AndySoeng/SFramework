...
Shader "CrossSectionURP/Simple Lit PC"
{
    ...
    Properties
    {
		...
		//[Toggle(CLIP_CYLINDER)] _clipCylinder("clipCylinder", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma multi_compile __ CLIP_CYLINDER // to get enumerated keywords as local.
        ...
        Pass
        {
			...
			// CrossSection Keywords
			#pragma multi_compile __ CLIP_PLANE
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX // to get enumerated keywords as local.
			#pragma shader_feature INVERSE
            // -------------------------------------
		...
		Pass
		{
			...
			//--------------------------------------
			// CrossSection Keywords
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX // to get enumerated keywords as local.
			#pragma shader_feature INVERSE
	...
	SubShader
	{
		...
		Pass
		{
			...
			// CrossSection Keywords
			#pragma multi_compile __ CLIP_PLANE
			#pragma multi_compile_local __ CLIP_CYLINDER // to get enumerated keywords as local.
    ...
    //CustomEditor "UnityEditor.CrossSection.URP.ShaderGUI.SimpleLitShader"
