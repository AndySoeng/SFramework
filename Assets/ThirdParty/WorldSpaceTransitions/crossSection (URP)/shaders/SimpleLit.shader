...
Shader "CrossSectionURP/Simple Lit"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			// -------------------------------------
			// CrossSection Keywords
			#pragma multi_compile __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX CLIP_CORNER CLIP_SPHERE_OUT
			//#pragma multi_compile_local __ CLIP_PLANE CLIP_TWO_PLANES CLIP_SPHERE CLIP_CUBOID CLIP_TUBES CLIP_BOX // to get enumerated keywords as local.
